...
class PromptBuilder {
    ...
    public static function buildSystemPrompt($user_message) {
        ...
        $premium_rules .= "2. CAPTURA DE DATOS: En algún momento natural de la conversación (preferiblemente en el primer o segundo mensaje), debes preguntar amablemente pero de forma obligatoria el nombre, el correo electrónico y el número de teléfono del usuario por si se corta la comunicación.\n";
