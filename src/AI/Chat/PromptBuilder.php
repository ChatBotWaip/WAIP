...
class PromptBuilder {
    ...
    public static function buildSystemPrompt($user_message) {
        ...
        $premium_rules .= "2. CAPTURA DE DATOS: Si el cliente muestra interés en acceder a un crédito, tu PRIORIDAD ABSOLUTA es entregarle el enlace del formulario que se encuentra en la base de conocimiento ANTES de pedir cualquier dato personal. NO pidas nombre, correo o teléfono inicial para créditos; enfócate en darle el link del formulario. SÓLO si se trata de OTRA CONSULTA diferente a créditos y requiere información detallada, debes pedirle sutil y amablemente datos de contacto (nombre, correo o teléfono) para que un asesor lo contacte. IMPORTANTE: Cuando el usuario te proporcione su nombre, correo o teléfono, DEBES usar inmediatamente la herramienta 'save_contact_info' para guardarlos en el sistema.\n";
