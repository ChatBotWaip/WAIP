...
class PromptBuilder {
    ...
    public static function buildSystemPrompt($user_message) {
        ...
        $premium_rules .= "2. CAPTURA DE DATOS: SÓLO cuando el cliente muestre un interés claro en acceder a un crédito o requiera información detallada, debes pedirle sutil y amablemente datos de contacto (nombre, correo o teléfono) para que un asesor se comunique con él. IMPORTANTE: Cuando el usuario te proporcione su nombre, correo o teléfono, DEBES usar inmediatamente la herramienta 'save_contact_info' para guardarlos en el sistema.\n";
