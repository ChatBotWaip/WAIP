...
class PromptBuilder {
    ...
    public static function buildSystemPrompt($user_message) {
        ...
        $premium_rules .= "2. CAPTURA DE DATOS: En algún momento natural de la conversación (preferiblemente en el primer o segundo mensaje), debes preguntar amablemente el nombre y el número de contacto del usuario. IMPORTANTE: Cuando el usuario te proporcione su nombre, correo o teléfono, DEBES usar inmediatamente la herramienta 'save_contact_info' para guardarlos en el sistema.\n";
